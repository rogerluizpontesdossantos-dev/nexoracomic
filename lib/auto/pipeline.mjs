...
function insertArticle(article) {
  ...
  // Insere ANTES da linha do marcador // [AUTO:END], garantindo que o novo
  // artigo permaneça DENTRO da região automática (entre [AUTO:BEGIN] e
  // [AUTO:END]) e depois dos artigos já existentes (ordem cronológica).
