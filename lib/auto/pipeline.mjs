...
function generateArticle(pauta, nextId) {
  ...
  return {
    ...
    imageAlt: 'Imagem relacionada a ' + item.title,
    sources: [sourceRef],
    meta: {
      generatedAt: nowIso,
...
export async function runPipeline(options = {}) {
  ...
  const article = generateArticle(best, nextId);
...
export { fetchAllFeeds, selectBestPauta, generateArticle, getNextId, findDuplicateHit };
